<?php 
    ...
    $query = "SELECT genere FROM users WHERE id = $userid";
...
<html>
    ...
    <main>
        ...
        <article>
            ...
            <p><strong>Contenuti da vedere</strong></p>

            <section id="view_non_visto">   
              
            </section>

            <p><strong>Contenuti Visti</strong></p>

            <section id="view_visto">
            ...
            <p><strong>Aggiorna il tuo profilo</strong></p>

            <section class="ricerche_profilo">

                <p>Scegli una <span class="azzurro">citazione</span> dal tuo anime preferito</p>
                ...
                <p>Scegli una <span class="azzurro">citazione</span> del tuo personaggio anime preferito</p>

                <form name='character' method='post'>

                    <input type='text' name='character' class="text">
                    <input type='submit' value="Cerca" class="button">
            ...
            <section id="view_quote">
            </section>

            <section class="ricerche_profilo border_top">

                <p>Scegli una <span class="azzurro">immagine</span> di un contenuto che hai visto</p>
                ...
                <p>Scegli un <span class="azzurro">poster</span> di un contenuto che hai visto</p>

                <form name='poster' method='post'>
