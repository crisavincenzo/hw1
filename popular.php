...
<html>
    <head>
        ...
        <script src="popular.js" defer="true"></script>
    ...
    <header>
        <h2>I più <span class="azzurro">popolari</span></h2>
        <h1>BingePlan</h1>   
    </header>
    ...
    <main>
        ...
        <article>
            ...
            <p class="azzurro"><strong>Serie popolari</strong></p>

            <section id="serie_view">
                 
                <img src="images/loading.gif" id="loading">
                              
            </section>

            <p class="azzurro"><strong >Film popolari</strong></p>

            <section id="film_view">
